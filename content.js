window.onload = async function main() {
    const promoCodes = ["10OFF", "15OFF", "PEPSI25"];
    ...
    if (window.location.href.includes("amazon")) {
        ...
        let promoCodeButton = document.getElementsByClassName('promo-submit')[0];
